...
namespace VectorTileServer
{
    ...
    public static class StreamHelper
    {
        ...
        /*
        public static System.IO.Stream Gzip(System.IO.Stream inputStream)
        {
            byte[] buffer = new byte[1024 * 1024]; // 1MB

            System.IO.MemoryStream deflateStream = new System.IO.MemoryStream();

            using (System.IO.Stream output = new System.IO.Compression.GZipStream(deflateStream,
            ...
            deflateStream.Seek(0, System.IO.SeekOrigin.Begin);

            return deflateStream;
        } // End Sub DeflateCompress


        public static System.IO.Stream Ungzip(System.IO.Stream stream)
        {
            if (!IsGZipped(stream))
                return stream;
            ...
            using (System.IO.Stream zipStream = new System.IO.Compression.GZipStream(stream, System.IO.Compression.CompressionMode.Decompress))
            {
        ...
        public static System.IO.Stream Deflate(System.IO.Stream inputStream)
        {
            byte[] buffer = new byte[1024 * 1024]; // 1MB

            System.IO.MemoryStream compressedStream = new System.IO.MemoryStream();

            using (System.IO.Stream output = new System.IO.Compression.DeflateStream(compressedStream,
                System.IO.Compression.CompressionMode.Compress))
            {
                long bytesRead = 0;
                while (bytesRead < inputStream.Length)
        ...
        public static System.IO.Stream Undeflate(System.IO.Stream stream)
        {
            // TODO: if(!IsDeflated(stream)) return stream;
            System.IO.MemoryStream resultStream = new System.IO.MemoryStream();

            using (System.IO.Stream compressedStream = new System.IO.Compression.DeflateStream(stream, System.IO.Compression.CompressionMode.Decompress))
            {
        ...
        } // End Function Undeflate 


        public static void Undeflate(System.IO.Stream stream, string fileName)
        {
            byte[] buffer = new byte[1024];
            ...
            try
            {
                using (System.IO.Stream decompressedStream = System.IO.File.Create(fileName))
                {
                    using (System.IO.Stream compressedStream = new System.IO.Compression.DeflateStream(
                        stream, System.IO.Compression.CompressionMode.Decompress))
                    {
                        int nRead;
                        while ((nRead = compressedStream.Read(buffer, 0, buffer.Length)) > 0)
        ...
        public static System.IO.Stream Brotli(System.IO.Stream inputStream)
        {
            return Compress<System.IO.Compression.BrotliStream>(inputStream);
        } // End Sub Brotli



        public static System.IO.Stream Unbrotli(System.IO.Stream stream)
        {
            // TODO: if(!IsDeflated(stream)) return stream;
            System.IO.MemoryStream resultStream = new System.IO.MemoryStream();

            using (System.IO.Stream compressedStream = new System.IO.Compression.BrotliStream(stream, System.IO.Compression.CompressionMode.Decompress))
            {
                compressedStream.CopyTo(resultStream);
                resultStream.Seek(0, System.IO.SeekOrigin.Begin);
                return resultStream;
        ...
        } // End Function Unbrotli 


        public static void Unbrotli(System.IO.Stream sourceStream, System.IO.Stream destinationStream)
        {
            Uncompress<System.IO.Compression.BrotliStream>(sourceStream, destinationStream);
        } // End Sub Unbrotli 


        public static void Unbrotli(System.IO.Stream source, string fileName)
        {
            Uncompress<System.IO.Compression.BrotliStream>(source, fileName);
        } // End Sub Unbrotli 
        */
