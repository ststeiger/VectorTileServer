...
*/
        ...
        )
        {
            ...
            zFile = argv[0].z != null && (argv[0].z.Length > 0) && argv[0].flags != MEM_Null
                ? sqlite3_value_text(argv[0])
                : string.Empty;
            zName = argv[1].z != null && (argv[1].z.Length > 0) && argv[1].flags != MEM_Null
            ...
            */
            ...
            if (db.aDb.Length <= db.nDb)
                Array.Resize(ref db.aDb,
                    db.nDb + 1); //aNew = sqlite3DbRealloc(db, db.aDb, sizeof(db.aDb[0])*(db.nDb+1) );
            if (db.aDb == null)
...
*/
        ...
        {
            string zName = !string.IsNullOrEmpty(argv[0].z)
                ? sqlite3_value_text(argv[0])
                : string.Empty; //(sqlite3_value_text(argv[0]);
            sqlite3 db = sqlite3_context_db_handle(context);
            int i;
            Db pDb = null;
