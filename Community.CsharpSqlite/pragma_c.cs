        ...
        */
        ...
        )
        {
            ...
            */
            ...
            if (minusFlag != 0)
            {
                zRight = (pValue == null) ? string.Empty : sqlite3MPrintf(db, "-%T", pValue);
            }
            else
            {
                                        ...
                                        if (zLeft.Equals("cache_size", StringComparison.OrdinalIgnoreCase))
                                        {
                                            ...
                                            */
                                            if (zLeft.Equals("temp_store", StringComparison.OrdinalIgnoreCase))
                                            {
                                                ...
                                                **
                                                */
                                                if (zLeft.Equals("temp_store_directory",
                                                    StringComparison.OrdinalIgnoreCase))
                                                {
                                                    if (null == zRight)
                                                    {
                                                        if (sqlite3_temp_directory.Length > 0)
                                                        {
                                                            sqlite3VdbeSetNumCols(v, 1);
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        if (zRight.Length > 0)
                                                        {
                                                            ...
                                                            rc = sqlite3OsAccess(db.pVfs, zRight,
                                                                SQLITE_ACCESS_READWRITE, ref res);
                                                        ...
                                                        if (zRight.Length > 0)
                                                        {
                                                            sqlite3_temp_directory =
                                                                zRight; //sqlite3_mprintf("%s", zRight);
                                                        }
                                                        else
                                                        {
                                                            sqlite3_temp_directory = string.Empty;
                                                        }
...
goto pragma_out;
                    ...
                    */
                                                            ...
                                                            zRight != null)
                                                        {
                                                            ...
                                                            if (pTab != null)
                                                            {
                                                                ...
                                                                pParse.nMem = 6;
                                                                sqlite3VdbeSetColName(v, 0, COLNAME_NAME, "cid",
                                                                    SQLITE_STATIC);
                                                                sqlite3VdbeSetColName(v, 1, COLNAME_NAME, "name",
                                                                    SQLITE_STATIC);
                                                                sqlite3VdbeSetColName(v, 2, COLNAME_NAME, "type",
                                                                    SQLITE_STATIC);
                                                                sqlite3VdbeSetColName(v, 3, COLNAME_NAME, "notnull",
                                                                    SQLITE_STATIC);
                                                                sqlite3VdbeSetColName(v, 4, COLNAME_NAME,
                                                                    "dflt_value", SQLITE_STATIC);
                                                                sqlite3VdbeSetColName(v, 5, COLNAME_NAME, "pk",
                                                                    SQLITE_STATIC);
                                                                ...
                                                                for (i = 0; i < pTab.nCol; i++) //, pCol++)
                                                                {
                                                                    ...
                                                                    sqlite3VdbeAddOp2(v, OP_Integer, i - nHidden,
                                                                        1);
                                                                    sqlite3VdbeAddOp4(v, OP_String8, 0, 2, 0,
                                                                        pCol.zName, 0);
                                                                    sqlite3VdbeAddOp4(v, OP_String8, 0, 3, 0,
                                                                        pCol.zType ?? string.Empty, 0);
                                                                    sqlite3VdbeAddOp2(v, OP_Integer,
                                                                        (pCol.notNull != 0 ? 1 : 0), 4);
                                                                    if (pCol.zDflt != null)
                                                                    {
                                                                        sqlite3VdbeAddOp4(v, OP_String8, 0, 5, 0,
                                                                            pCol.zDflt, 0);
                                                                    }
                                                                    else
                                                                    {
                                                                    ...
                                                                    sqlite3VdbeAddOp2(v, OP_Integer,
                                                                        pCol.isPrimKey != 0 ? 1 : 0, 6);
                                                                    sqlite3VdbeAddOp2(v, OP_ResultRow, 1, 6);
                                                                }
                                                            }
                                                        }
                                                        else if (zLeft.Equals("index_info",
                                                                     StringComparison.OrdinalIgnoreCase) &&
                                                                 zRight != null)
                                                        {
                                                            Index pIdx;
                                                            ...
                                                            if (pIdx != null)
                                                            {
                                                                ...
                                                                pParse.nMem = 3;
                                                                sqlite3VdbeSetColName(v, 0, COLNAME_NAME, "seqno",
                                                                    SQLITE_STATIC);
                                                                sqlite3VdbeSetColName(v, 1, COLNAME_NAME, "cid",
                                                                    SQLITE_STATIC);
                                                                sqlite3VdbeSetColName(v, 2, COLNAME_NAME, "name",
                                                                    SQLITE_STATIC);
                                                                for (i = 0; i < pIdx.nColumn; i++)
                                                                {
                                                                    ...
                                                                    sqlite3VdbeAddOp4(v, OP_String8, 0, 3, 0,
                                                                        pTab.aCol[cnum].zName, 0);
                                                                    sqlite3VdbeAddOp2(v, OP_ResultRow, 1, 3);
                                                                }
                                                            }
                                                        }
                                                        else if (zLeft.Equals("index_list",
                                                                     StringComparison.OrdinalIgnoreCase) &&
                                                                 zRight != null)
                                                        {
                                                            Index pIdx;
                                                            ...
                                                            if (pTab != null)
                                                            {
                                                                ...
                                                                if (pIdx != null)
                                                                {
                                                                    ...
                                                                    sqlite3VdbeSetNumCols(v, 3);
                                                                    pParse.nMem = 3;
                                                                    sqlite3VdbeSetColName(v, 0, COLNAME_NAME, "seq",
                                                                        SQLITE_STATIC);
                                                                    sqlite3VdbeSetColName(v, 1, COLNAME_NAME,
                                                                        "name", SQLITE_STATIC);
                                                        ...
                                                        else if (zLeft.Equals("database_list",
                                                            StringComparison.OrdinalIgnoreCase))
                                                        {
                                                            int i;
                                                            if (sqlite3ReadSchema(pParse) != 0)
                                                            ...
                                                            sqlite3VdbeSetColName(v, 1, COLNAME_NAME, "name",
                                                                SQLITE_STATIC);
                                                            sqlite3VdbeSetColName(v, 2, COLNAME_NAME, "file",
                                                                SQLITE_STATIC);
                                                            for (i = 0; i < db.nDb; i++)
                                                            {
                                                        ...
                                                        else if (zLeft.Equals("collation_list",
                                                            StringComparison.OrdinalIgnoreCase))
                                                        {
                                                            int i = 0;
                                                            HashElem p;
                                                            ...
                                                            for (p = db.aCollSeq.first;
                                                                p != null;
                                                                p = p
                                                                    .next) //( p = sqliteHashFirst( db.aCollSeq ) ; p; p = sqliteHashNext( p ) )
                                                            {
                                                                CollSeq pColl =
                                                                    ((CollSeq[]) p.data)[0]; // sqliteHashData( p );
                                                                sqlite3VdbeAddOp2(v, OP_Integer, i++, 1);
                                                                sqlite3VdbeAddOp4(v, OP_String8, 0, 2, 0,
                                                                    pColl.zName, 0);
...
#if !SQLITE_OMIT_FOREIGN_KEY
                                                        if (zLeft.Equals("foreign_key_list",
                                                                StringComparison.OrdinalIgnoreCase) &&
                                                            zRight != null)
                                                        {
                                                            FKey pFK;
                                                            ...
                                                            if (pTab != null)
                                                            {
                                                                ...
                                                                if (pFK != null)
                                                                {
                                                                    ...
                                                                    pParse.nMem = 8;
                                                                    sqlite3VdbeSetColName(v, 0, COLNAME_NAME, "id",
                                                                        SQLITE_STATIC);
                                                                    sqlite3VdbeSetColName(v, 1, COLNAME_NAME, "seq",
                                                                        SQLITE_STATIC);
                                                                    sqlite3VdbeSetColName(v, 2, COLNAME_NAME,
                                                                        "table", SQLITE_STATIC);
                                                                    sqlite3VdbeSetColName(v, 3, COLNAME_NAME,
                                                                        "from", SQLITE_STATIC);
                                                                    sqlite3VdbeSetColName(v, 4, COLNAME_NAME, "to",
                                                                        SQLITE_STATIC);
                                                                    sqlite3VdbeSetColName(v, 5, COLNAME_NAME,
                                                                        "on_update", SQLITE_STATIC);
                                                                    sqlite3VdbeSetColName(v, 6, COLNAME_NAME,
                                                                        "on_delete", SQLITE_STATIC);
                                                                    sqlite3VdbeSetColName(v, 7, COLNAME_NAME,
                                                                        "match", SQLITE_STATIC);
                                                                    while (pFK != null)
                                                                    {
                                                                        int j;
                                                                        for (j = 0; j < pFK.nCol; j++)
                                                                        {
                                                                            ...
                                                                            sqlite3VdbeAddOp4(v, OP_String8, 0, 3,
                                                                                0, pFK.zTo, 0);
                                                                            sqlite3VdbeAddOp4(v, OP_String8, 0, 4,
                                                                                0,
                                                                                pTab.aCol[pFK.aCol[j].iFrom].zName,
                                                                                0);
                                                                            sqlite3VdbeAddOp4(v,
                                                                                zCol != null ? OP_String8 : OP_Null,
                                                                                0, 5, 0, zCol, 0);
                                                                            sqlite3VdbeAddOp4(v, OP_String8, 0, 6,
                                                                                0, zOnUpdate, 0);
                                                                            sqlite3VdbeAddOp4(v, OP_String8, 0, 7,
                                                                                0, zOnDelete, 0);
                                                                            sqlite3VdbeAddOp4(v, OP_String8, 0, 8,
                                                                                0, "NONE", 0);
                                                            ...
                                                            StringComparison.OrdinalIgnoreCase))
                                                        {
                                                            if (zRight != null)
                                                            {
                                                                ...
                                                                {
                                                                    sqlite3ParserTrace(null, string.Empty);
                                                                }
                                                            }
                                                        }
                                                        else
          ...
          */
                                                            if (zLeft.Equals("case_sensitive_like",
                                                                StringComparison.OrdinalIgnoreCase))
                                                            {
                                                                if (zRight != null)
                                                                {
            ...
            */
                                                                if (zLeft.Equals("integrity_check",
                                                                        StringComparison.OrdinalIgnoreCase)
                                                                    || zLeft.Equals("quick_check",
                                                                        StringComparison.OrdinalIgnoreCase)
                                                                )
                                                                {
                                                                    const int SQLITE_INTEGRITY_CHECK_ERROR_MAX =
                                                                        100;
                                                                    int i, j, addr, mxErr;
                                                                    ...
                                                                    */
                                                                    ...
                                                                    sqlite3VdbeAddOp2(v, OP_Integer, mxErr,
                                                                    ...
                                                                    for (i = 0; i < db.nDb; i++)
                                                                    {
                                                                        ...
                                                                        addr = sqlite3VdbeAddOp1(v, OP_IfPos,
                                                                        ...
                                                                        */
                                                                        Debug.Assert(
                                                                            sqlite3SchemaMutexHeld(db, iDb, null));
                                                                        ...
                                                                        sqlite3VdbeAddOp3(v, OP_IntegrityCk, 2, cnt,
                                                                            1);
                                                                        ...
                                                                        */
                                                                            ...
                                                                            x = x.next)
                                                                        {
                                                                            ...
                                                                            sqlite3VdbeAddOp2(v, OP_Halt, 0, 0);
                                                                            sqlite3VdbeJumpHere(v, addr);
                                                                            sqlite3OpenTableAndIndices(pParse, pTab,
                                                                                1, OP_OpenRead);
                                                                            sqlite3VdbeAddOp2(v, OP_Integer, 0,
                                                                                2); /* reg(2) will count entries */
                                                                            loopTop = sqlite3VdbeAddOp2(v,
                                                                                OP_Rewind, 1, 0);
                                                                            sqlite3VdbeAddOp2(v, OP_AddImm, 2,
                                                                                ...
                                                                                pIdx = pIdx.pNext, j++)
                                                                            {
                                                                                ...
                                                                                VdbeOpList[] idxErr =
                                                                                    new VdbeOpList[]
                                                                                    {
                                                                                        new VdbeOpList(OP_AddImm, 1,
                                                                                            -1, 0),
                                                                                        new VdbeOpList(OP_String8,
                                                                                            0, 3, 0), /* 1 */
                                                                                        new VdbeOpList(OP_Rowid, 1,
                                                                                            4, 0),
                                                                                        new VdbeOpList(OP_String8,
                                                                                            0, 5, 0), /* 3 */
                                                                                        new VdbeOpList(OP_String8,
                                                                                            0, 6, 0), /* 4 */
                                                                                        new VdbeOpList(OP_Concat, 4,
                                                                                            3, 3),
                                                                                        new VdbeOpList(OP_Concat, 5,
                                                                                            3, 3),
                                                                                        new VdbeOpList(OP_Concat, 6,
                                                                                            3, 3),
                                                                                        new VdbeOpList(OP_ResultRow,
                                                                                            3, 1, 0),
                                                                                        new VdbeOpList(OP_IfPos, 1,
                                                                                            0, 0), /* 9 */
                                                                                        new VdbeOpList(OP_Halt, 0,
                                                                                            0, 0),
                                                                                    };
                                                                                r1 = sqlite3GenerateIndexKey(pParse,
                                                                                    pIdx, 1, 3, false);
                                                                                jmp2 = sqlite3VdbeAddOp4Int(v,
                                                                                    OP_Found, j + 2, 0, r1,
                                                                                    pIdx.nColumn + 1);
                                                                                addr = sqlite3VdbeAddOpList(v,
                                                                                    ArraySize(idxErr), idxErr);
                                                                                sqlite3VdbeChangeP4(v, addr + 1,
                                                                                    "rowid ", SQLITE_STATIC);
                                                                                sqlite3VdbeChangeP4(v, addr + 3,
                                                                                    " missing from index ",
                                                                                    SQLITE_STATIC);
                                                                                sqlite3VdbeChangeP4(v, addr + 4,
                                                                                    pIdx.zName, P4_TRANSIENT);
                                                                                sqlite3VdbeJumpHere(v, addr + 9);
                                                                                sqlite3VdbeJumpHere(v, jmp2);
                                                                            }

                                                                            sqlite3VdbeAddOp2(v, OP_Next, 1,
                                                                                loopTop + 1);
                                                                                ...
                                                                                pIdx = pIdx.pNext, j++)
                                                                            {
                                                                                VdbeOpList[] cntIdx =
                                                                                    new VdbeOpList[]
                                                                                    {
                                                                                        new VdbeOpList(OP_Integer,
                                                                                            0, 3, 0),
                                                                                        new VdbeOpList(OP_Rewind, 0,
                                                                                            0, 0), /* 1 */
                                                                                        new VdbeOpList(OP_AddImm, 3,
                                                                                            1, 0),
                                                                                        new VdbeOpList(OP_Next, 0,
                                                                                            0, 0), /* 3 */
                                                                                        new VdbeOpList(OP_Eq, 2, 0,
                                                                                            3), /* 4 */
                                                                                        new VdbeOpList(OP_AddImm, 1,
                                                                                            -1, 0),
                                                                                        new VdbeOpList(OP_String8,
                                                                                        ...
                                                                                        new VdbeOpList(OP_String8,
                                                                                            0, 3, 0), /* 7 */
                                                                                        new VdbeOpList(OP_Concat, 3,
                                                                                            2, 2),
                                                                                        new VdbeOpList(OP_ResultRow,
                                                                                            2, 1, 0),
                                                                                    };
                                                                                addr = sqlite3VdbeAddOp1(v,
                                                                                    OP_IfPos, 1);
                                                                                sqlite3VdbeAddOp2(v, OP_Halt, 0, 0);
                                                                                sqlite3VdbeJumpHere(v, addr);
                                                                                addr = sqlite3VdbeAddOpList(v,
                                                                                    ArraySize(cntIdx), cntIdx);
                                                                                sqlite3VdbeChangeP1(v, addr + 1,
                                                                                    j + 2);
                                                                                sqlite3VdbeChangeP2(v, addr + 1,
                                                                                    addr + 4);
                                                                                sqlite3VdbeChangeP1(v, addr + 3,
                                                                                    j + 2);
                                                                                sqlite3VdbeChangeP2(v, addr + 3,
                                                                                    addr + 2);
                                                                                sqlite3VdbeJumpHere(v, addr + 4);
                                                                                sqlite3VdbeChangeP4(v, addr + 6,
                                                                                    "wrong # of entries in index ",
                                                                                    P4_STATIC);
                                                                                sqlite3VdbeChangeP4(v, addr + 7,
                                                                                    pIdx.zName, P4_TRANSIENT);
                                                                            }
                                                                        }
                                                                    }
                                                                    ...
                                                                    addr = sqlite3VdbeAddOpList(v,
                                                                        ArraySize(endCode), endCode);
                                                                    sqlite3VdbeChangeP2(v, addr, -mxErr);
                                                                    sqlite3VdbeJumpHere(v, addr + 1);
                                                                    sqlite3VdbeChangeP4(v, addr + 2, "ok",
                                                                        P4_STATIC);
                                                                }
                                                                else
                                                                        ...
                                                                        StringComparison.OrdinalIgnoreCase))
                                                                    {
                                                                        ...
                                                                        if (null == zRight)
                                                                        {
                                                                            ...
                                                                            if (sqlite3ReadSchema(pParse) != 0)
                                                                            {
                                                                                ...
                                                                                pParse.zErrMsg = null;
                                                                                pParse.rc =
                                                                                    0; //  reset errors goto pragma_out;
                                                                            }

                                                                            sqlite3VdbeSetNumCols(v, 1);
                                                                            sqlite3VdbeSetColName(v, 0,
                                                                                COLNAME_NAME, "encoding",
                                                                                SQLITE_STATIC);
                                                                            sqlite3VdbeAddOp2(v, OP_String8, 0, 1);
                                                                            Debug.Assert(
                                                                                encnames[SQLITE_UTF8].enc ==
                                                                                SQLITE_UTF8);
                                                                            Debug.Assert(
                                                                                encnames[SQLITE_UTF16LE].enc ==
                                                                                SQLITE_UTF16LE);
                                                                            Debug.Assert(
                                                                                encnames[SQLITE_UTF16BE].enc ==
                                                                                SQLITE_UTF16BE);
                                                                            sqlite3VdbeChangeP4(v, -1,
                                                                                encnames[ENC(pParse.db)].zName,
                                                                                P4_STATIC);
                                                                            sqlite3VdbeAddOp2(v, OP_ResultRow, 1,
                                                                                1);
                                                                        }
...
sqlite3ErrorMsg( pParse, "unsupported encoding: %s", zRight );
                ...
                */
                                                                        if (zLeft.Equals("schema_version",
                                                                                StringComparison.OrdinalIgnoreCase)
                                                                            || zLeft.Equals("user_version",
                                                                                StringComparison.OrdinalIgnoreCase)
                                                                            || zLeft.Equals("freelist_count",
                                                                                StringComparison.OrdinalIgnoreCase)
                                                                        )
                                                                        {
                                                                            int
                                                                                iCookie; /* Cookie index. 1 for schema-cookie, 6 for user-cookie. */
                                                                            sqlite3VdbeUsesBtree(v, iDb);
                                                                            switch (zLeft[0])
                                                                            {
                                                                                case 'f':
                                                                                ...
                                                                                iCookie != BTREE_FREE_PAGE_COUNT)
                                                                            {
                                                                                ...
                                                                                VdbeOpList[] setCookie =
                                                                                    new VdbeOpList[]
                                                                                    {
                                                                                        ...
                                                                                        new VdbeOpList(OP_Integer,
                                                                                            0, 1, 0), /* 1 */
                                                                                        new VdbeOpList(OP_SetCookie,
                                                                                            0, 0, 1), /* 2 */
                                                                                    };
                                                                                int addr = sqlite3VdbeAddOpList(v,
                                                                                    ArraySize(setCookie),
                                                                                    setCookie);
                                                                                sqlite3VdbeChangeP1(v, addr, iDb);
                                                                                sqlite3VdbeChangeP1(v, addr + 1,
                                                                                    sqlite3Atoi(zRight));
                                                                                sqlite3VdbeChangeP1(v, addr + 2,
                                                                                    iDb);
                                                                                sqlite3VdbeChangeP2(v, addr + 2,
                                                                                    iCookie);
                                                                            }
                                                                            else
                                                                            {
                                                                                /* Read the specified cookie value */
                                                                                VdbeOpList[] readCookie =
                                                                                    new VdbeOpList[]
                                                                                    {
                                                                                        new VdbeOpList(
                                                                                            OP_Transaction, 0, 0,
                                                                                ...
                                                                                int addr = sqlite3VdbeAddOpList(v,
                                                                                    readCookie.Length,
                                                                                    readCookie); // ArraySize(readCookie), readCookie);
                                                                                sqlite3VdbeChangeP1(v, addr, iDb);
                                                                                sqlite3VdbeChangeP1(v, addr + 1,
                                                                                    iDb);
                                                                        ...
                                                                        else if (zLeft.Equals("reload_schema",
                                                                            StringComparison.OrdinalIgnoreCase))
                                                                        {
                                                                            /* force schema reloading*/
                                                                            sqlite3ResetInternalSchema(db, -1);
                                                                        }
                                                                        else if (zLeft.Equals("file_format",
                                                                            StringComparison.OrdinalIgnoreCase))
                                                                        {
                  ...
                  ** one option per row.
                  */
                                                                            if (zLeft.Equals("compile_options",
                                                                                StringComparison.OrdinalIgnoreCase))
                                                                            {
                                                                                int i = 0;
                                                                                string zOpt;
                                                                                ...
                                                                                pParse.nMem = 1;
                                                                                sqlite3VdbeSetColName(v, 0,
                                                                                    COLNAME_NAME, "compile_option",
                                                                                    SQLITE_STATIC);
                                                                                while ((zOpt =
                                                                                           sqlite3_compileoption_get(
                                                                                               i++)) != null)
                                                                                {
                                                                                    sqlite3VdbeAddOp4(v, OP_String8,
                                                                                        0, 1, 0, zOpt, 0);
                                                                                    sqlite3VdbeAddOp2(v,
                                                                                        OP_ResultRow, 1, 1);
                                                                                }
           ...
           SQLITE_PTR_TO_INT(db->pWalArg) : 0);
                    ...
                    */
                                                                                        ...
                                                                                        .OrdinalIgnoreCase))
                                                                                {
                                                                                    ...
                                                                                    pParse.nMem = 2;
                                                                                    sqlite3VdbeSetColName(v, 0,
                                                                                        COLNAME_NAME, "database",
                                                                                        SQLITE_STATIC);
                                                                                    sqlite3VdbeSetColName(v, 1,
                                                                                        COLNAME_NAME, "status",
                                                                                        SQLITE_STATIC);
                                                                                    for (i = 0; i < db.nDb; i++)
                                                                                    {
                                                                                ...
                                                                                {
                                                                                    sqlite3_key(db, zRight,
                                                                                        sqlite3Strlen30(zRight));
                                                                                }
                                                                                else if (zLeft.Equals("rekey",
                                                                                             StringComparison
                                                                                                 .OrdinalIgnoreCase) &&
                                                                                         !string.IsNullOrEmpty(
                                                                                             zRight))
                                                                                {
                                                                                    sqlite3_rekey(db, zRight,
                                                                                        sqlite3Strlen30(zRight));
                                                                                }
