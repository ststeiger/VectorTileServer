      ...
      */
            ...
            )
            {
                ...
                ////if ( 0 == db.mallocFailed )
                {
                    ...
                    pStr2.u.zToken = pStr2.u.zToken.Substring(0, sqlite3Strlen30(pStr2.u.zToken) - 1) +
                                     (char) (c + 1); // pC = c + 1;
                }
            ...
            ** are used */
            ...
            for (int _pt = 0; _pt < pWC.nTerm; _pt++) //<pWCEnd; pTerm++)
            {
                ...
                )
                {
                    ...
                    for (int _pOrWC = 0;
                        _pOrWC < pOrWC.nTerm;
                        _pOrWC++) //pOrTerm = pOrWC.a ; pOrTerm < pOrWCEnd ; pOrTerm++ )
                    {
        ...
        */
        ...
        )
        {
            ...
            */
            ...
            zAff = new StringBuilder(sqlite3IndexAffinityStr(v,
                pIdx)); //sqlite3DbStrDup(pParse.db, sqlite3IndexAffinityStr(v, pIdx));
            //if( null==zAff ){
            //  pParse.db.mallocFailed = 1;
            //}
...
/* TK_GE */ OP_SeekGe
                ...
                */
                if (pWInfo.nLevel > 1)
                {
                    ...
                    for (k = 1; k <= nNotReady; k++)
                    {
                        pOrTab.a[k] =
                            origSrc
                                [pWInfo.a[iLevel + k].iFrom]; // memcpy(&pOrTab.a[k], &origSrc[pLevel[k].iFrom], sizeof(pOrTab.a[k]));
                    }
                }
                else
                {
            ...
            */
            for (j = pWC.nTerm; j > 0; j--) //, pTerm++)
            {
                ...
                if (pLevel.iLeftJoin != 0 && !((pE.flags & EP_FromJoin) == EP_FromJoin)
