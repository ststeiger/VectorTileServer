...
#else
    static tcl.lang.Var.SQLITE3_GETSET sqlite3_interrupt_count =
 new tcl.lang.Var.SQLITE3_GETSET( "sqlite3_interrupt_count" );
#endif
#endif
        ...
        )
        {
            ...
            */
            ...
            //if ( SQLITE_OK == sqlite3VdbeMemGrow( pMem, nByte, 0 ) )
            {
                ...
                {
                    pCx.pCursor =
                        sqlite3MemMallocBtCursor(pCx
                            .pCursor); // (BtCursor)&pMem.z[ROUND8(sizeof( VdbeCursor )) + 2 * nField * sizeof( u32 )];
                    ...
                    */
                    case OP_Concat:
                    {
                        ...
                        if (pIn2.z != null && pIn2.z.Length >= pIn2.n)
                            if (pIn1.z != null)
                                pOut.z = pIn2.z.Substring(0, pIn2.n) +
                                         (pIn1.n < pIn1.z.Length ? pIn1.z.Substring(0, pIn1.n) : pIn1.z);
                            else
                            {
                                if ((pIn1.flags & MEM_Blob) == 0) //String as Blob
                                {
                                    ...
                                    pOut.z = pIn2.z.Substring(0, pIn2.n) +
                                             Encoding.UTF8.GetString(pIn1.zBLOB, 0, pIn1.zBLOB.Length);
                            }
                        else
                        {
                    ...
                    case OP_Function:
                    {
                        ...
                        */
                        ...
                        if ((ctx.pFunc.flags & SQLITE_FUNC_NEEDCOLL) != 0)
                        {
                            ...
                            Debug.Assert(p.aOp[pc - 1].p4type ==
                                         P4_COLLSEQ); //Debug.Assert(pOp[-1].p4type == P4_COLLSEQ);
                            Debug.Assert(p.aOp[pc - 1].opcode ==
                                         OP_CollSeq); //Debug.Assert(pOp[-1].opcode == OP_CollSeq);
                        ...
                        else
                        {
                            ...
                            ** an error is returned to the user.  */
                            for (
                                ...
                                pSavepoint != null &&
                                !pSavepoint.zName.Equals(zName, StringComparison.OrdinalIgnoreCase);
                            ...
                            else
                            {
                                ...
                                ** is committed.
                                */
                                int isTransaction = (pSavepoint.pNext == null && db.isTransactionSavepoint != 0)
                                    ? 1
                                    : 0;
                    ...
                    */
                    case OP_VerifyCookie:
                    {
                        ...
                        if (iMeta != pOp.p2 || iGen != pOp.p3)
                        {
                            sqlite3DbFree(db, ref p.zErrMsg);
                            p.zErrMsg =
                                "database schema has changed"; // sqlite3DbStrDup(db, "database schema has changed");
                ...
                sqlite3_search_count.iValue++;
                    ...
                    */
                    ...
                    case OP_Found:
                    {
                        ...
                        UnpackedRecord
                            aTempRec =
                                new UnpackedRecord(); //char aTempRec[ROUND8(sizeof(UnpackedRecord)) + sizeof(Mem)*3 + 7];
                        ...
                        ** is already allocated. Otherwise, it must be initialized.  */
                        if ((pRt.flags & MEM_Frame) == 0)
                        {
                            ...
                            */
                            ...
                            for (int i = 0;
                                i < pFrame.aChildMem.Length;
                                i++) //pMem = VdbeFrameMem( pFrame ) ; pMem != pEnd ; pMem++ )
                            {
