        ...
        )
        {
            ...
            for (zIdx = 0; zIdx < zInput.Length; zIdx += n) //z=zInput; *z; z=z+n)
            {
                ...
                if (token == TK_REFERENCES)
                {
                    ...
                    zParent = zIdx + n < zInput.Length
                        ? zInput.Substring(zIdx, n)
                        : string.Empty; //sqlite3DbStrNDup(db, zIdx, n);
...
*/
        static void sqlite3AlterFinishAddColumn(Parse pParse, Token pColDef)
        {
            ...
            zDb = db.aDb[iDb].zName;
            zTab = pNew.zName
                .Substring(16); // zTab = &pNew->zName[16]; /* Skip the "sqlite_altertab_" prefix on the name */
          ...
          */
            ...
            */
            ...
            zCol = pColDef.z.Substring(0, pColDef.n).Replace(";", " ")
                .Trim(); //sqlite3DbStrNDup(db, (char*)pColDef.z, pColDef.n);
            if (zCol != null)
            {
