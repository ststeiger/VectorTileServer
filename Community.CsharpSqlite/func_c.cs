        ...
        */
        ...
        )
        {
            ...
            if (z2 != null)
            {
                ...
                //}
                sqlite3_result_text(context, z2.Length == 0 ? string.Empty : z2.Substring(0, n).ToUpper(), -1,
                    null); //sqlite3_free );
                // }
            }
        }
        ...
        )
        {
            ...
            if (z2 != null)
            {
                ...
                //  }
                sqlite3_result_text(context, z2.Length == 0 ? string.Empty : z2.Substring(0, n).ToLower(), -1,
                    null); //sqlite3_free );
                //}
            }
        }
...
// use versionFunc here just for a dummy placeholder
                new FuncDef(-1, SQLITE_UTF8, SQLITE_FUNC_COALESCE, null, null, versionFunc, null, null, "coalesce",
                    null, null),
...
/* AGGREGATE(count,             0, 0, 0, countStep,       countFinalize  ), */
                new FuncDef(0, SQLITE_UTF8, SQLITE_FUNC_COUNT, null, null, null, countStep, countFinalize, "count",
                    null, null),
