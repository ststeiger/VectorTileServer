            ...
            switch (op)
            {
                case SQLITE_CONFIG_PCACHE:
                {
                    ...
                    sqlite3GlobalConfig.pcache =
                        ap; //sqlite3GlobalConfig.pcache = (sqlite3_pcache_methods)va_arg(ap, "sqlite3_pcache_methods");
                    break;
                }
            }
    ...
    */
            ...
            )
            {
                ...
                ** method that there may be extra parameters following the file-name.  */
                ...
                if (zUri[5] == '/' && zUri[6] == '/')
                {
                    ...
                    if (iIn != 7 && (iIn != 16 || String.Compare("localhost", zUri.Substring(7, 9),
                                         StringComparison.OrdinalIgnoreCase) !=
                                     0)) //memcmp("localhost", &zUri[7], 9)) )
                    {
      ...
      */
            ...
            */
            ...
            Buffer.BlockCopy(aHardLimit, 0, db.aLimit, 0,
                aHardLimit.Length * sizeof(int)); //memcpy(db.aLimit, aHardLimit, sizeof(db.aLimit));
            db.autoCommit = 1;
            db.nextAutovac = -1;
            db.nextPagesize = 0;
