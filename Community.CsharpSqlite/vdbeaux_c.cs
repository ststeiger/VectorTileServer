            ...
            if (serial_type >= 12)
            {
                ...
                if ((len = (u32) pMem.n) != 0)
                    if (pMem.zBLOB == null && string.IsNullOrEmpty(pMem.z))
                    {
                        ...
                        Buffer.BlockCopy(Encoding.UTF8.GetBytes(pMem.z), 0, buf, offset,
                            (int) len); //memcpy( buf, pMem.z, len );
        ...
        )
        {
            switch (serial_type)
            {
                ...
                case 4:
                {
                    ...
                    pMem.u.i = (int) (((sbyte) buf[offset + 0] << 24) | (buf[offset + 1] << 16) |
                ...
                case 5:
                {
                    ...
                    u32 y = (u32) ((buf[offset + 2] << 24) | (buf[offset + 3] << 16) | (buf[offset + 4] << 8) |
                                   buf[offset + 5]);
                    x = (x << 32) | y;
                    pMem.u.i = (i64) x;
                    pMem.flags = MEM_Int;
...
swapMixedEndianFloat(t2);
                    ...
                    Debug.Assert(sizeof(double) == sizeof(u64) &&
                                 memcmp(BitConverter.GetBytes(r1), BitConverter.GetBytes(t2), sizeof(double)) ==
                                 0); //Debug.Assert( sizeof(r1)==sizeof(t2) && memcmp(&r1, t2, sizeof(r1))==0 );
#endif

                    x = (u64) ((buf[offset + 0] << 24) | (buf[offset + 1] << 16) | (buf[offset + 2] << 8) |
                               buf[offset + 3]);
                    y = (u32) ((buf[offset + 4] << 24) | (buf[offset + 5] << 16) | (buf[offset + 6] << 8) |
                               buf[offset + 7]);
                    x = (x << 32) | y;
                    if (serial_type == 6)
                    {
        ...
        */
        ...
        )
        {
            ...
            */
            ...
            idx1 = (u32) ((szHdr1 = pKey1[offset]) <= 0x7f
                ? 1
                : getVarint32(pKey1, offset, out szHdr1)); // GetVarint( aKey1, szHdr1 );
            d1 = (int) szHdr1;
            ...
            while (idx1 < szHdr1 && i < pPKey2.nField)
            {
                ...
                idx1 += (u32) ((serial_type1 = pKey1[offset + idx1]) <= 0x7f
                        ? 1
                        : getVarint32(pKey1, (uint) (offset + idx1), out serial_type1)
                ...
                */
                d1 += (int) sqlite3VdbeSerialGet(pKey1, offset + d1, serial_type1,
                    mem1); //sqlite3VdbeSerialGet( aKey1, d1, serial_type1, mem1 );
