...
const int ;//#define SQLITE_UTF16NATIVE  SQLITE_UTF16LE
        ...
        static u8
            SQLITE_UTF16NATIVE =
                (SQLITE_BIGENDIAN != 0
                    ? SQLITE_UTF16BE
                    : SQLITE_UTF16LE); //#define SQLITE_UTF16NATIVE (SQLITE_BIGENDIAN?SQLITE_UTF16BE:SQLITE_UTF16LE)
#endif
    ...
    */
        ...
        */
        static string
            SCHEMA_TABLE(int x) //#define SCHEMA_TABLE(x)  ((!OMIT_TEMPDB)&&(x==1)?TEMP_MASTER_NAME:MASTER_NAME)
        {
...
sqlite3 *pNextBlocked;        /* Next in list of all blocked connections */
        ...
        */
        ...
        const int
            SQLITE_MAGIC_SICK = 0x3b771290; //#define SQLITE_MAGIC_SICK     0x4b771290  /* Error and awaiting close */

        const int
            SQLITE_MAGIC_BUSY = 0x403b7906; //#define SQLITE_MAGIC_BUSY     0xf03b7906  /* Database currently in use */

        const int
            SQLITE_MAGIC_ERROR =
                0x55357930; //#define SQLITE_MAGIC_ERROR    0xb5357930  /* An SQLITE_MISUSE error occurred */
        ...
        */
        public class FuncDef
        {
            ...
            public FuncDef(i16 nArg, u8 iPrefEnc, u8 iflags, object pUserData, FuncDef pNext, dxFunc xFunc,
                dxStep xStep, dxFinal xFinalize, string zName, FuncDef pHash, FuncDestructor pDestructor)
            {
                this.nArg = nArg;
        ...
        */
        ...
        const int
            SQLITE_COLL_REVERSE = 3; //#define SQLITE_COLL_REVERSE 3  /* The built-in REVERSE collating sequence */
        ...
        */
        ...
        const int
            SQLITE_STOREP2 = 0x10; //#define SQLITE_STOREP2      0x10  /* Store result in reg[P2] rather than jump */
    ...
    */
        ...
        */
        public class WhereInfo
        {
            ...
            public WhereLevel[]
                a = new WhereLevel[] {new WhereLevel()}; /* Information about each nest loop in the WHERE */
        };
...
the <column-list> is stored here */
        ...
        */
        public class StrAccum
        {
            ...
            public i64 nChar
            {
                get { return zText.Length; }
            }

            public bool tooBig
            {
                get { return mxAlloc > 0 && zText.Length > mxAlloc; }
            }
        };
