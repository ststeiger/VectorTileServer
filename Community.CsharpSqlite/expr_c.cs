            ...
            if (pNew != null)
            {
                ...
                if (pToken != null)
                {
                    ...
                    else
                    {
                        ...
                        if (pToken.n > 0)
                            pNew.u.zToken =
                                pToken.z.Substring(0, pToken.n); //memcpy(pNew.u.zToken, pToken.z, pToken.n);
            ...
            else
            {
                ...
                else
                {
                    ...
                    */
                    ...
                    {
                        if (pParse.azVar[i] != null && z.CompareTo(pParse.azVar[i]) == 0
                        ) //memcmp(pParse.azVar[i],z,n+1)==0 )
                        {
            ...
            if (pList != null)
            {
                ...
                pItem.zSpan = pSpan.zStart.Substring(0,
                    pSpan.zStart.Length <= pSpan.zEnd.Length
                        ? pSpan.zStart.Length
                        : pSpan.zStart.Length - pSpan.zEnd.Length); // sqlite3DbStrNDup( db, pSpan.zStart,
