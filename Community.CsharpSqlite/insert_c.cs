        ...
        static string sqlite3IndexAffinityStr(Vdbe v, Index pIdx)
        {
            if (pIdx.zColAff == null || pIdx.zColAff[0] == '\0')
            {
                ...
                */
                ...
                StringBuilder
                    pIdx_zColAff =
                        new StringBuilder(pIdx.nColumn + 2); // (char )sqlite3DbMallocRaw(0, pIdx->nColumn+2);
...
//# define autoIncStep(A,B,C)
        ...
        */
        ...
        static void sqlite3Insert(Parse pParse, SrcList pTabList, int null_3, Select pSelect, IdList pColumn,
            int onError)
        {
            sqlite3Insert(pParse, pTabList, null, pSelect, pColumn, onError);
        }

        static void sqlite3Insert(Parse pParse, SrcList pTabList, ExprList pList, int null_4, IdList pColumn,
            int onError)
        {
...
#else
    static tcl.lang.Var.SQLITE3_GETSET sqlite3_xferopt_count =
 new tcl.lang.Var.SQLITE3_GETSET( "sqlite3_xferopt_count" );
#endif
#endif // * SQLITE_TEST */
