...
#else
    static tcl.lang.Var.SQLITE3_GETSET sqlite3_pager_readdb_count =
 new tcl.lang.Var.SQLITE3_GETSET( "sqlite3_pager_readdb_count" );
    static tcl.lang.Var.SQLITE3_GETSET sqlite3_pager_writedb_count =
 new tcl.lang.Var.SQLITE3_GETSET( "sqlite3_pager_writedb_count" );
    static tcl.lang.Var.SQLITE3_GETSET sqlite3_pager_writej_count =
 new tcl.lang.Var.SQLITE3_GETSET( "sqlite3_pager_writej_count" );
#endif
    ...
    */
        ...
        */
        static i64 journalHdrOffset(Pager pPager)
        {
            ...
            if (c != 0)
            {
                offset = (int) (((c - 1) / pPager.sectorSize + 1) *
                                pPager.sectorSize
...
0==MEMDB
            ...
            if (pPg != null)
            {
                ...
                ** Do this before any decoding. */
                if (pgno == 1)
                {
                    Buffer.BlockCopy(pData, 24, pPager.dbFileVers, 0,
                        pPager.dbFileVers
                            .Length); //memcpy(pPager.dbFileVers, ((u8*)pData)[24], sizeof(pPager.dbFileVers));
                }
        ...
        */
        static int pager_playback(Pager pPager, int isHot)
        {
            ...
            */
            ...
            {
                rc = sqlite3OsAccess(pVfs, Encoding.UTF8.GetString(zMaster, 0, zMaster.Length), SQLITE_ACCESS_EXISTS,
                    ref res);
            }
...
0 == MEMDB
            ...
            if (pgno == 1)
            {
                ...
                else
                {
                    ...
                    Buffer.BlockCopy(pPg.pData, 24, pPager.dbFileVers, 0,
                        pPager.dbFileVers.Length); //memcpy(&pPager.dbFileVers, dbFileVers, sizeof(pPager.dbFileVers));
                }
            }
...
#else
    static tcl.lang.Var.SQLITE3_GETSET sqlite3_opentemp_count =
 new tcl.lang.Var.SQLITE3_GETSET( "sqlite3_opentemp_count" );
#endif
#endif
                ...
                if (pList.pgno <= pPager.dbSize && 0 == (pList.flags & PGHDR_DONT_WRITE))
                {
                    ...
                    */
                    if (pgno == 1)
                    {
                        Buffer.BlockCopy(pData, 24, pPager.dbFileVers, 0,
                            pPager.dbFileVers
                                .Length); // memcpy(pPager.dbFileVers, pData[24], pPager.dbFileVers).Length;
                    }
                    ...
                    if (noContent != 0)
                    {
                        ...
                        */
                        ...
                        if (pgno <= pPager.dbOrigSize)
                        {
                            ...
                            rc = sqlite3BitvecSet(pPager.pInJournal,
                                pgno); //TESTONLY( rc = ) sqlite3BitvecSet(pPager.pInJournal, pgno);
#else
...
#if !NDEBUG || SQLITE_COVERAGE_TEST
                        rc = addToSavepointBitvecs(pPager,
                            pgno); //TESTONLY( rc = ) addToSavepointBitvecs(pPager, pgno);
#else
