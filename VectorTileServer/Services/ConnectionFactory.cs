        ...
        : IConnectionFactory
    {
        ...
        private static System.Data.Common.DbProviderFactory GetFactory(System.Type type)
        {
                ...
                .IsSubclassOf(typeof(System.Data.Common.DbProviderFactory)))
            {
                ...
                if (field != null)
                {
                    object? providerObject = field.GetValue(null);

                    if (providerObject != null)
                    {
                        return (System.Data.Common.DbProviderFactory)providerObject;
                    }

                } // End if (field != null)

                System.Reflection.PropertyInfo? property = System.Reflection.IntrospectionExtensions.GetTypeInfo(type).GetProperty("Instance"
                    , System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static
                );

                if (property != null)
                {
                    object? providerObject = property.GetValue(null);
        ...
        public ConnectionFactory(string connectionString)
            : this(connectionString, typeof(Microsoft.Data.Sqlite.SqliteFactory))
        { }
